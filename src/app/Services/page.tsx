const Services = () => {
  return (
    <>
      ...
      <p className="text-center mt-2">At Party Sharty we specialize in creating memorable birthday events  From kids&apos parties to milestone birthdays, we handle every detail to make your celebration stress-free and fun!”</p>
      <h2 className="mt-5 pt-3 text-center text-4xl font-bold text-yellow-700">What we Offer at Party Sharty</h2>
      <ul className="font-semibold pb-5">
        <li className="mt-5 font-sans p-3" ><strong>Kids&apos Themed Parties:</strong> We create magical experiences with customized themes, decorations, and entertainment tailored to your child’s favorite characters and interests.</li>
