...
const  Contact= () => {
  return (
    ...
    <div className="flex justify-center items-center m-8 ">
      <form action="#" className="flex flex-col items-center justify-center border-black w-96 h-96 p-5 rounded-2xl bg-gradient-to-r from-orange-400 to-pink-400">
        <label htmlFor="fname" >First Name</label>
        <input type="text" required className="border-black rounded-xl w-72" />
        ...
        <input type="date" required className="border-black rounded-xl w-72"/>
        <label htmlFor="">Conatct Number</label>
        <input type="number" required className="border-black rounded-xl w-72"/>
